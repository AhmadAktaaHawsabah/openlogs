...
export { canonicalize, decodeTpsUid, ed25519Sign, ed25519Verify, generateEd25519Keypair, generateTpsUid, hexToBytes, normalizeTpsUri, randomBytes, sha256Hex, utf8ToBytes } from './core/index.js';
...
export { KeyRegistry, SigningKeyInfo, extractSigningKeys, groupBySigningKey } from './keys.js';
